...
abstract class Ders{            //public tanımlanmıyor  (c#)
    protected String dersAdi, dersKodu, donem;
    protected boolean secmeli;
    protected int kredi;
    protected Akademisyen dersSorumlusu;

    private List <Ogrenci> ogrenciListesi;      //bu derse sahip öğrenciler
    ...
    public void derseYazilim(Ogrenci ogrenci){
        ogrenciListesi.add(ogrenci);            //o derse ait öğrencileri ekleme
    }
