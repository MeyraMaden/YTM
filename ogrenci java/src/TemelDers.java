public class TemelDers extends Ders{
    public TemelDers(String dersAdi,String dersKodu,String donem, boolean secmeli,Akademisyen dersSorumlusu, int kredi){
        ...
        //alt sınıfın yapıcısında (constructor) üst sınıfın yapıcısını çağırmak için kullanılır.
 ...
 * bir alt sınıfın (subclass) üst sınıfının (superclass) 
 * elemanlarına erişim sağlamak için kullanılır
 */
